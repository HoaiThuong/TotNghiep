    ...
    <>
      <header className="header-top-strip py-3">
        <div className="container-xxl">
          <div className="row">
            <div className="col-6">
              <p className="text-white mb-0">Free Shipping Over Giá.100</p>
            </div>
            <div className="col-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <div className="d-flex flex-column gap-10">
                      ...
                      <p className="mb-0">
                        Giá. {!cartState?.length ? 0 : total ? total : 0}
                      </p>
                    </div>
                  </Link>
                </div>
                ...
                <div>
                  <div className="dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      {[
                        { text: "Chăm Sóc Da Mặt", icon: "🌸" },
                        { text: "Chăm Sóc Cơ Thể", icon: "🛁" },
                        { text: "Trang Điểm", icon: "💄" },
                        { text: "Phụ Kiện", icon: "🎀" },
                        { text: "Dược Mỹ Phẩm", icon: "💊" },
